...
def get_claude_env() -> Dict[str, str]:
    ...
    Note: ANTHROPIC_API_KEY is optional - Claude CLI will use subscription if not provided.
    ...
    """
    required_env_vars = {
        # Anthropic Configuration (optional - will use Claude CLI subscription if not provided)
